...
import '../modules/edit_doctor_detail/bindings/edit_doctor_detail_binding.dart';
import '../modules/edit_doctor_detail/views/edit_doctor_detail_view.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      name: _Paths.EDIT_DOCTOR_DETAIL,
      page: () => EditDoctorDetailView(),

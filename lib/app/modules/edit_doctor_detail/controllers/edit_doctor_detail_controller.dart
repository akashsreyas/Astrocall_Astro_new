...
class EditDoctorDetailController extends GetxController
  ...
  void onInit() {
    ...
    if (doctor != null) {
      ...
      searchName.value = doctor!.doctorName!.toLowerCase();
  ...
  void saveDoctorDetail() async {
    ...
    if (formkey.currentState!.validate() && doctorCategory != null) {
      ...
      try {
        await DoctorService().updateDoctorDetails(
          doctorName: doctorName.value,
          searchName:doctorName.value.toLowerCase(),

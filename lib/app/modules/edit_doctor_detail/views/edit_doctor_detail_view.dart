...
import 'package:hallo_doctor_doctor_app/app/modules/edit_doctor_detail/views/pages/chose_doctor_category_page_edit.dart';
...
import '../../add_doctor_detail/controllers/add_doctor_detail_controller.dart';
import '../controllers/edit_doctor_detail_controller.dart';

class EditDoctorDetailView extends StatelessWidget {
  final EditDoctorDetailController _adddoctorController = Get.put(EditDoctorDetailController());
  @override
  Widget build(BuildContext context) {

    _adddoctorController.textAcademicQualificationController.text=_adddoctorController.doctor!.academicQualification!;
    _adddoctorController.textPastExprienceInCompanyController.text=_adddoctorController.doctor!.pastExperienceInCompany!;
    _adddoctorController.textPastExprienceInConsultingController.text=_adddoctorController.doctor!.pastExperienceInConsulting!;
    _adddoctorController.textConsultingFeesController.text=_adddoctorController.doctor!.doctorPrice!.toString();
    _adddoctorController.textAgeController.text=_adddoctorController.doctor!.age!.toString();
    _adddoctorController.textRecognitionController.text=_adddoctorController.doctor!.recognition!;
    _adddoctorController.textValueYouBringController.text=_adddoctorController.doctor!.valueYouBring!;
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: GetX<EditDoctorDetailController>(
            builder: (controller) => Column(
              children: [
                ...
                TextField(
                  ...
                  textInputAction: TextInputAction.done,
                  onSubmitted: (value) =>
                      controller.pastExperienceInCompany = value,
                ),
                SizedBox(height: 20),
                TextField(
                ...
                TextField(
                  ...
                  textInputAction: TextInputAction.done,
                  onSubmitted: (value) =>
                      controller.valueYouBring = value,
                ),
                SizedBox(height: 20),
                TextButton(
                  style: TextButton.styleFrom(
                    primary: Styles.primaryOrange,
                  ...
                  onPressed: () {
                    Get.to(() => ChoseDoctorCategoryPageEdit());
                  },
                  child: Row(
                    children: [
                      SizedBox(width: 20),

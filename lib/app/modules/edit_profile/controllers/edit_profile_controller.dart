...
import '../views/pages/update_username_page.dart';

class EditProfileController extends GetxController {
  //TODO: Implement EditProfileController

  var username = UserService().currentUser!.displayName.obs;
  ...
  toChangeUsername() => Get.to(() => UpdateUsernamePage());
  ...
  void updateUsername(String username) {
    EasyLoading.show(maskType: EasyLoadingMaskType.black);
    UserService().updateEmail(username).then((value) {
      Get.back();
